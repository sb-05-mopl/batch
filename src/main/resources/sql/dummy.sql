...
VALUES ('10000000-0000-0000-0000-000000000001', 101001, '2024-01-01 00:00:00', 'MOVIE', '인터스텔라', '우주를 배경으로 한 SF 대작',
        'https://example.com/thumbs/interstellar.jpg', 4.5, 120),
       ('10000000-0000-0000-0000-000000000002', 101002, '2024-01-02 00:00:00', 'MOVIE', '기생충', '계급 격차를 그린 스릴러',
        'https://example.com/thumbs/parasite.jpg', 4.8, 250),
       ('10000000-0000-0000-0000-000000000003', 101003, '2024-01-03 00:00:00', 'MUSIC', '블랙핑크 - Pink Venom',
        'K-POP 히트곡', 'https://example.com/thumbs/pinkvenom.jpg', 4.3, 89),
       ('10000000-0000-0000-0000-000000000004', 101004, '2024-01-04 00:00:00', 'MOVIE', '아바타: 물의 길', '판도라 행성의 새로운 모험',
        'https://example.com/thumbs/avatar2.jpg', 4.2, 180),
       ('10000000-0000-0000-0000-000000000005', 101005, '2024-01-05 00:00:00', 'BOOK', '1984', '조지 오웰의 디스토피아 소설',
        'https://example.com/thumbs/1984.jpg', 4.7, 340),
       ('10000000-0000-0000-0000-000000000006', 101006, '2024-01-06 00:00:00', 'MUSIC', 'NewJeans - OMG', '인기 K-POP 곡',
        'https://example.com/thumbs/omg.jpg', 4.4, 95),
       ('10000000-0000-0000-0000-000000000007', 101007, '2024-01-07 00:00:00', 'MOVIE', '탑건: 매버릭', '전투기 조종사의 귀환',
        'https://example.com/thumbs/topgun.jpg', 4.6, 210),
       ('10000000-0000-0000-0000-000000000008', 101008, '2024-01-08 00:00:00', 'BOOK', '해리포터와 마법사의 돌',
        'J.K. 롤링의 판타지 소설', 'https://example.com/thumbs/hp1.jpg', 4.9, 450),
       ('10000000-0000-0000-0000-000000000009', 101009, '2024-01-09 00:00:00', 'MUSIC', 'IU - Love wins all',
        '아이유 발라드곡', 'https://example.com/thumbs/lovewin.jpg', 4.7, 112),
       ('10000000-0000-0000-0000-00000000000a', 101010, '2024-01-10 00:00:00', 'MOVIE', '범죄도시 3', '한국 액션 영화',
        'https://example.com/thumbs/crime3.jpg', 4.1, 165),
       ('10000000-0000-0000-0000-00000000000b', 101011, '2024-01-11 00:00:00', 'BOOK', '노르웨이의 숲', '무라카미 하루키 소설',
        'https://example.com/thumbs/norway.jpg', 4.3, 280),
       ('10000000-0000-0000-0000-00000000000c', 101012, '2024-01-12 00:00:00', 'MOVIE', '오펜하이머', '원자폭탄 개발 이야기',
        'https://example.com/thumbs/oppenheimer.jpg', 4.5, 195),
       ('10000000-0000-0000-0000-00000000000d', 101013, '2024-01-13 00:00:00', 'MUSIC', 'BTS - Dynamite', 'BTS 히트곡',
        'https://example.com/thumbs/dynamite.jpg', 4.8, 320),
       ('10000000-0000-0000-0000-00000000000e', 101014, '2024-01-14 00:00:00', 'MOVIE', '서울의 봄', '한국 현대사 드라마',
        'https://example.com/thumbs/seoul.jpg', 4.6, 230),
       ('10000000-0000-0000-0000-00000000000f', 101015, '2024-01-15 00:00:00', 'BOOK', '살인자의 기억법', '김영하 장편소설',
        'https://example.com/thumbs/killer.jpg', 4.2, 175);
...
VALUES ('90000000-0000-0000-0000-000000000001', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', '새로운 팔로워',
       ...
       ('90000000-0000-0000-0000-000000000009', 'd9eebc99-9c0b-4ef8-bb6d-6bb9bd380aaa', '중요 공지', '2024-02-22 10:00:00',
        '보안 업데이트를 진행해주세요.', 'URGENT', NULL),
       ('90000000-0000-0000-0000-00000000000a', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', '플레이리스트 구독',
        '2024-02-12 18:05:00', '한지민님이 회원님의 플레이리스트를 구독했습니다.', 'INFO', '2024-02-13 09:00:00');
